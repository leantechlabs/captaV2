...
const Sidebar = () => {
  return (
    <aside className="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-2" id="sidenav-main">
      ...
      <div className="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <a className="nav-link" href="#usersSubmenu" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="usersSubmenu" id="usersToggle">
              <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li className="nav-item">
            <a className="nav-link" href="#institutionSubmenu" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="institutionSubmenu" id="institutionToggle">
              <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li className="nav-item">
            <a className="nav-link" href="#moduleSubmenu" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="moduleSubmenu" id="moduleToggle">
              <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div className="collapse" id="moduleSubmenu">
              <ul className="navbar-nav">
                <li className="nav-item">
                  <a className="nav-link" href="/manage/add-curriculum">
                    <span className="nav-link-text ms-3">Add Curriculum</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/manage/add-module">
                    <span className="nav-link-text ms-3">Add Module</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/manage/module-confirmation-sheet">
                    <span className="nav-link-text ms-3">Module Confirmation Sheet</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/trainer/day-work">
